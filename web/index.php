				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					...
					<li class="dropdown menu__item">
						<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Stationary <span class="caret"></span></a>
								...
								<div class="agile_inner_drop_nav_info">
									...
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
											...
											<li><a href="#">PensNPencil</a></li>
											<li><a href="#">Craft</a></li>
											<li><a href="#">SchoolBags</a></li>
					...
					<li class="dropdown menu__item">
						<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Gifts <span class="caret"></span></a>
							<ul class="dropdown-menu multi-column columns-3">
								<div class="agile_inner_drop_nav_info">
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
			...
			<div class="item active">
				<div class="container">
					<div class="carousel-caption">
						<h3>All About Papers<span></span></h3>
								...
								<div class="login">
									<div class="login-bottom">
										...
										<form action = "login.php" method = "POST">
											...
											<div class="sign-up">
												<input type="submit" value="REGISTER NOW", name="login" >
											</div>
